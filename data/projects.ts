...
export const projects: Project[] = [
  {
    ...
    description: `Built during the NextStart Incubator — an AI companion device for children. Worked with a team of talented software engineers from market research through MVP launch: defined target segments, developed go-to-market strategy, and collaborated with mentors to validate product-market fit. A zero-to-one venture that demonstrates startup building capability.`,
    techStack: ["Market Research", "MVP Development", "Go-to-Market", "Product-Market Fit", "Competitive Analysis"],
