            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 mb-20">
                    <div className="max-w-2xl">
                        ...
                        >
                            Ready to build <br />
                            <span className="font-serif italic text-gold-accent">from zero</span>.
                        </motion.h2>
                        <p className="text-xl text-text-body max-w-lg">
                            I thrive in environments where I can take ownership, move fast, and turn ideas into real products.
                            Let me prove it.
                        </p>
                    </div>
