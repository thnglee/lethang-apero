                    ...
                    >
                        <div className="flex items-center justify-center p-8 md:p-12">
                            <p className="text-base md:text-lg text-gray-400 font-light leading-relaxed text-center font-serif italic max-w-3xl">
                                "Beyond these projects, I also played core-team roles in multiple ventures with Xpath, Thinkmay, NextTech — building products from scratch, leading teams, and shipping under real constraints..."
                            </p>
                        </div>
                    </motion.div>
                </div>
